...
API_TOKEN = '5186827794:AAHGfysPZ6fMakSInFccOdRfMprY-2z1iIU'
PRODUCTS = [
...
async def product_one_callback(call: types.CallbackQuery):
    await bot.answer_callback_query(callback_query_id=call.id, text='Нету такого товара:(', show_alert=True)
